...
const navItems = [
  ...
  { icon: FaLinkedinIn, label: 'LinkedIn',    href: 'https://linkedin.com/in/[your-linkedin]',  external: true  },
  { icon: SiX,          label: 'Twitter / X', href: 'https://x.com/[your-handle]',             external: true  },
  { icon: Mail,         label: 'Email',       href: 'mailto:[your-email]',                      external: false },
]
